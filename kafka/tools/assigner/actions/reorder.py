  ...
  def process_cluster(self):
    ...
    for partition in self.cluster.partitions():
      ...
      if new_leader is None:
        for replica in partition.replicas:
          leader_ratio = leaders[replica] / self.cluster.brokers[replica].num_partitions()
      ...
      if new_leader != partition.replicas[0]:
        partition.swap_replica_positions(self.cluster.brokers[new_leader], self.cluster.brokers[partition.replicas[0]])
