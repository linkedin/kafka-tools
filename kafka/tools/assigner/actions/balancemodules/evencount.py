...
class ActionBalanceEvencount(ActionBalanceModule):
    name = "evencount"
    helpstr = "Evenly spread topics across the cluster"

    def check_topic_ok(self, topic):
            # In evencount, we don't skip topics because of partition count
    ...
    def process_cluster(self):
        ...
        ordered_brokers = self.cluster.brokers.keys().sorted()
