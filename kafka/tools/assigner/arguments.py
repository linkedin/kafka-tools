...
def set_up_arguments(action_map, sizer_map, plugins):
    ...
    aparser.add_argument('-i', '--include-topics', help="Comma-separated list of topics to include when performing actions. Default will be empty list means include all topics",
                         action=CSVAction, default=[])
