...
import tests.tools.assigner.fixturemodules.noclass
from kafka.tools.assigner.modules import get_modules, is_class, check_class, check_classes_in_module
...
class ModulesTests(unittest.TestCase):
    ...
    def test_check_class_noparent(self):
        assert check_class(TestClassNoParent, tests.tools.assigner.fixturemodules.ModuleTesterBaseClass) is None

    def test_check_classes_in_module(self):
        module_list = check_classes_in_module(tests.tools.assigner.fixturemodules.inherited, tests.tools.assigner.fixturemodules.ModuleTesterBaseClass)
        assert module_list == [ModuleInheritedFromBase]

    def test_check_classes_in_module_noclasses(self):
        module_list = check_classes_in_module(tests.tools.assigner.fixturemodules.noclass, tests.tools.assigner.fixturemodules.ModuleTesterBaseClass)
        assert module_list == []
