...
class GroupTests(unittest.TestCase):
    ...
    def test_set_assignment(self):
        ...
        member.set_assignment(b'\x00\x00\x00\x00\x00\x01\x00\x06topic1\x00\x00\x00\x00\x00\x02\x65\xbd')
        assert member.assignment_version == 0
        assert member.assignment_data == b'\x00\x00\x00\x00\x00\x01\x00\x06topic1\x00\x00\x00\x00\x00\x02\x65\xbd'
